...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='代理所属擂台（针对单个擂台）';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='代理帐号';
...
CREATE TABLE `lt_agent_user_log` (
  ...
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='代理用户日志';
...
CREATE TABLE `lt_arena` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `mark` (`mark`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=459 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='擂台列表';
...
) ENGINE=InnoDB AUTO_INCREMENT=458 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='房间机器人';
...
CREATE TABLE `lt_arena_bet_detail` (
  ...
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `arena_id` (`arena_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=184 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='擂台投注详情表';
...
CREATE TABLE `lt_arena_bet_view` (
  ...
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='投注单查看购买';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='擂台征信用户列表';
...
CREATE TABLE `lt_arena_deposit_detail` (
  ...
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `arena_id` (`arena_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=458 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='擂台押金详情表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1543 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='擂台日志';
...
CREATE TABLE `lt_arena_odds` (
  ...
  KEY `arena_id` (`arena_id`) USING BTREE,
  KEY `mark` (`mark`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=938 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='擂台赔率变更列表';
...
CREATE TABLE `lt_arena_recommend` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='后台擂台推荐';
...
) ENGINE=InnoDB AUTO_INCREMENT=1898 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='擂台投注项列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='首页模块';
...
CREATE TABLE `lt_manager_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=1951 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='管理员登录日志';
...
) ENGINE=MyISAM AUTO_INCREMENT=7963 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='赛事列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=841983 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='赔率表';
...
CREATE TABLE `lt_odds_company` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='博彩公司';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='博彩公司关联赛事类型';
...
) ENGINE=MyISAM AUTO_INCREMENT=15958882 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='赔率走势表';
...
CREATE TABLE `lt_play` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=91999 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='比赛列表';
...
CREATE TABLE `lt_play_fenxi` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='比赛分析表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='比赛列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=404 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='比赛结果';
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='比赛与玩法对应';
...
CREATE TABLE `lt_play_rules_detail` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `md5` (`md5`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=40663 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=184071 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='比赛队伍列表';
...
CREATE TABLE `lt_queue` (
  ...
  KEY `mark` (`mark`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='任务队列';
...
CREATE TABLE `lt_rules` (
  ...
  KEY `type` (`type`) USING BTREE,
  KEY `game_id` (`game_id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=136 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='比赛项目玩法';
...
) ENGINE=MyISAM AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='比赛项目玩法选项';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='擂台输赢统计';
...
) ENGINE=MyISAM AUTO_INCREMENT=851964 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='用户在线状态详情';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='用户主题 - 在线时长';
...
CREATE TABLE `lt_stat_online_user` (
  ...
  UNIQUE KEY `s_date` (`s_date`,`game_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='用户主题 - 在线用户数';
...
CREATE TABLE `lt_system_income` (
  ...
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=862 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统收益';
...
) ENGINE=InnoDB AUTO_INCREMENT=62251 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统资金详情表';
...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统公告';
...
CREATE TABLE `lt_sys_message` (
  ...
  KEY `type` (`type`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=22267 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `lt_sys_message_detail` (
  ...
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=56207 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=67642 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统消息队列';
...
) ENGINE=MyISAM AUTO_INCREMENT=31298 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='队伍列表';
...
) ENGINE=MyISAM AUTO_INCREMENT=9915 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='队伍排名';
...
CREATE TABLE `lt_top_bonus` (
  ...
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=5933 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='TOP奖金榜';
...
CREATE TABLE `lt_top_hit` (
  ...
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=5933 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='TOP命中榜';
...
CREATE TABLE `lt_top_leitai_win` (
  ...
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=533 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='TOP擂台大神榜';
...
CREATE TABLE `lt_user_funds_log` (
  ...
  KEY `type` (`type`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=136857 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户资金详情表';
...
CREATE TABLE `lt_user_level` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户等级';
...
) ENGINE=MyISAM AUTO_INCREMENT=9790 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户日志';
