    ...
    public function entry($id = '')
    {
        ...
        if ($this->useZh) {
            ...
            for ($i = 0; $i < $this->length; $i++) {
                ...
                if(!$i){
                    $codeNX = $this->fontSize / 2;
                }else{
                    $codeNX += min(mt_rand($this->fontSize * 1.2, $this->fontSize * 1.6) - $this->fontSize / 3,$limit);
                }
                //$codeNX += mt_rand($this->fontSize * $i, $this->fontSize * $i);
