...
/*        cache("oauth_{$token}",$user,$this->expire);
    ...
    public function getPad($uuid){
        return \think\Cache::hGet('user_pad_info',$uuid);
    }

    public function getTokenByUserId($userId){
        return \think\Cache::hGet('user_list_userId',$userId);
    }

    public function getUserIdByToken($token){
        return \think\Cache::hGet('user_list_token',$token);
    }
    public function getUuidByToken($token){
        return \think\Cache::hGet('user_list_uuid',$token);
    }
