...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.container.find('.clearBtn').html(this.locale.clearLabel).addClass(this.clearClass);
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if (this.showDropdowns) {
                ...
                var monthHtml = '<select class="monthselect form-control pull-left">';
                for (var m = 0; m < 12; m++) {
                ...
                var yearHtml = '<select class="yearselect form-control pull-left">';
