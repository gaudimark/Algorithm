...
class Stringnew{
    ...
    static public function keyGen() {
        return str_replace('-','',substr(Stringnew::uuid(),1,-1));
    }
    ...
    static public function buildFormatRand($format,$number=1) {
        ...
        for($j=0; $j<$number; $j++) {
            ...
            for($i=0; $i<$length; $i++) {
                ...
                switch($char){
                    case "*"://字母和数字混合
                        $strtemp   .= Stringnew::randString(1);
                        break;
                    case "#"://数字
                        $strtemp  .= Stringnew::randString(1,1);
                        break;
                    case "$"://大写字母
                        $strtemp .=  Stringnew::randString(1,2);
                        break;
                    default://其他格式均不转换
                        $strtemp .=   $char;
                        break;
     ...
     * @return mixed
     */
    static public function utf8_strlen($string = ''){
